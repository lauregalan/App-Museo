...
import QrEscaner from '@/app/QrEscaner';

export default function three(){

    const [permission, requestPermission] = useCameraPermissions() //el hook que me da expo 
    //devuelve el granted  (si acepto el permiso) y una funcion requestPermission q es para pedir
    // el persmiso
